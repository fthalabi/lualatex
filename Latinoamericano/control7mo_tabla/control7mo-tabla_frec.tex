...
muestras = obtener_muestras(
  np.random.choice([14,15,16]),
  np.random.choice([3,4]),
  np.random.choice([25,26,27,28])
)
...
\NewDocumentCommand{\f}{m}{\pgfmathprintnumber[fixed,precision=2,verbatim,use comma]{#1}}
