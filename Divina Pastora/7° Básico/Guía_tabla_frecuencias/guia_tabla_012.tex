...
\providecommand{\subtituloDocumento}{Tabla de frecuencias (\# 012)}
...
\begin{center}\includegraphics{grafico_vacio_012.pdf}\end{center}
...
\begin{center}\begin{tblr}{colspec={ccccc},hlines,vlines,hline{2,Z} = {1}{-}{},hline{2,Z} = {2}{-}{},row{even}={black!10}}
 ...
 \end{tblr}\end{center}
\subsection{}
\begin{center}\includegraphics{grafico_barras_012.pdf}\end{center}
\end{document}
