...
\newtcolorbox{grid}[1][]{enhanced,inherit height,colback=white,colframe=black,boxrule=1pt,underlay={\begin{tcbclipinterior}
    \draw[help lines,step=5mm,yshift=10pt] (interior.south west) grid (interior.north east);\end{tcbclipinterior}},#1}


\begin{document}
%
\Caja[Nombre][0.6\textwidth][30pt]%
\Caja[\faIcon{calculator}][0.10\textwidth][30pt]%
...
\begin{enumerate}[label={\bfseries\alph* -.},itemsep=1cm,leftmargin=1.5cm]
    \item \begin{tcolorbox}[blanker,sidebyside,lefthand width=.4\linewidth,height=5cm,box align=top,halign upper=center]
        \tikz[line width=1pt,every node/.style={}]{\draw (0,0) -- node [text width=1cm,draw,dashed,minimum height=25pt,above=5pt,anchor=south east] {} (20:4cm) -- node [midway,right=5pt] {12} ([turn]-90:3cm) -- node [midway,below=5pt] {13} cycle;
    ...
    \end{tcolorbox}
    \item \begin{tcolorbox}[blanker,sidebyside,lefthand width=.4\linewidth,height=5cm,box align=top,halign upper=center]
        \tikz[line width=1pt,every node/.style={midway}]{\draw (0,0) -- node [midway,left=5pt] {10} (-80:3cm) -- node [midway,below=5pt] {24} ([turn]90:4cm) -- node[draw,rounded corners,minimum height=25pt,dashed,text width=1cm,above=5pt,anchor=south west] {} cycle;
...
\begin{center}
    \begin{tikzpicture}[x=0.7cm,y=0.7cm]
        \draw[->,shorten >=-5mm,line width=1pt] (0,0) -- (0,13) node[pos=1,above,yshift=5mm] {$y$};
        ...
        \draw[line width=1pt,fill=black!20] (1,0) -- (8,0) -- (17,12) -- cycle;
        \fill (1,0) circle (3pt);
        \fill (8,0) circle (3pt);
        \fill (17,12) circle (3pt);
        \draw[help lines,xstep=1,ystep=1] (0,0) grid (18,13);
    \end{tikzpicture}
\end{center}
...
\begin{tcolorbox}[enhanced,inherit height,colback=white,colframe=black,boxrule=1pt,underlay boxed title={\begin{tcbclipinterior}
    ...
    boxed title style={colback=white},coltitle=black,height=8cm]
\end{tcolorbox}
