\RequirePackage{fontspec} % For loading OpenType fonts
\RequirePackage{unicode-math} % For modern math font handling
...
\tikzset{
  ...
  samples=200,
  pattern/.default={Lines[angle=-45,distance=5pt]}
}
